...
export const authApi = {
  ...
  /** First-login password change — admin-created accounts only.
   *  Body: { newPassword }. Doesn't require currentPassword. */
  firstLoginPasswordChange: (newPassword) =>
    client.put('/auth/first-login-password-change', { newPassword }).then(r => r.data),
}
